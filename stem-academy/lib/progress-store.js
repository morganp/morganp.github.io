...
(function (global) {
  ...
  const TOPICS = {
    ...
    "weather-climate": { label: "Weather & Climate", level: "L2" },
    "earths-structure": { label: "Earth's Structure", level: "L2" },
    "plate-tectonics": { label: "Plate Tectonics", level: "L3" },
    "rock-cycle-detail": { label: "Rock Cycle Detail & Dating", level: "L3" },
    "solar-system": { label: "Solar System Tour", level: "L1" },
    "day-night": { label: "Day, Night & the Moon", level: "L1" },
    "scale-orbits": { label: "Scale & Orbits", level: "L2" },
    "stars": { label: "Stars & Constellations", level: "L2" },
    "the-universe": { label: "The Universe & Big Bang", level: "L3" },
    "number-line": { label: "Number & the Number Line", level: "L1" },
    "shapes-angles": { label: "Shapes & Angles", level: "L1" },
    "data-graphs": { label: "Data & Graphs", level: "L1" },
    "fractions-percent": { label: "Fractions, Decimals & Percentages", level: "L2" },
    "algebra-basics": { label: "Algebra & the Balance", level: "L2" },
    "geometry-measure": { label: "Angles, Area & Perimeter", level: "L2" },
    "coordinates": { label: "Coordinates & Straight Lines", level: "L2" },
    "probability": { label: "Probability", level: "L2" },
