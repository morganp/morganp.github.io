...
```mermaid
flowchart LR
    A["Twigs and buds in opposite pairs?"] -->|yes| B["Leaf type"]
    A -->|"no, alternate"| C["Leaf or needle"]
    B -->|"pinnate, 7 to 13 leaflets"| ASH["Ash"]
    B -->|"one blade, 5 palmate lobes"| SYC["Sycamore"]
    B -->|"5 to 7 leaflets from one point"| HCH["Horse chestnut"]
    C -->|needles| D["Needle arrangement"]
    C -->|"broad leaf"| E["Leaf margin"]
    D -->|"in pairs, twisted"| SPI["Scots pine"]
    D -->|"single, flat, two ranks"| YEW["Yew"]
    E -->|"rounded lobes, eared base"| OAK["Oak"]
    E -->|"wavy edge, no teeth"| BEE["Beech"]
    E -->|"spiny, glossy, evergreen"| HOL["Holly"]
    E -->|"small triangle, doubly toothed"| BIR["Silver birch"]
    E -->|"round, hairy, abrupt point"| HAZ["Hazel"]
```
